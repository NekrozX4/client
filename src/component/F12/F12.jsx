    ...
    <div className={`F12-container ${lightMode ? 'light-mode' : ''}`}>
      ...
      <div className='main-history-container'>
        <div className='dropdown-container'>
          <label htmlFor='agenceDropdown'>Select Agence:</label>
          <select
            id='agenceDropdown'
          ...
          >
            ...
            {Object.keys(organizedData).map((groupKey) => (
              ...
              {selectedAgence ? (
        <div className='selected-agence-data'>
          ...
          <button className = "envoi-btn" onClick={() => handlePreviewPDF(selectedAgence)}>Generer liste F12</button>
